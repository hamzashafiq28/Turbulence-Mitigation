...
def save_image(turb_images, image_names, loc):
    ...
    for ind in range(batch_num):
        image_path = image_names[ind]
        image_name = os.path.basename(image_path)
        output_path = os.path.join(loc, image_name)
        utils.save_image(turb_images[ind], output_path)

# Example usage:
# turb_images is a tensor containing images
# image_names is a list containing paths of input images
# loc is the directory where you want to save the images
# save_image(turb_images, image_names, loc)
...
if __name__ == "__main__":
    ...
    print("Validation completed in {:.2f} seconds".format(duration))
